...
from ImportDataTodo.forms import TodoForm
from TodoProject import settings
from ImportDataTodo.csv2model import csv2model, csv2dic
from TodoProject.pagination import Custom_Paging
    ...
    def create(self, request, *args, **kwargs):
        if (request.POST.get('todo_user') == str(request.user.id)) \
            ...
            data = {
                ...
                'todo_user' : request.POST.get('todo_user',request.user.id),
